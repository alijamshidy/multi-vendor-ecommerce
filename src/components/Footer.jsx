...
const Footer = () => {
  return (
    <div className="w-full h-full flex justify-center items-center bg-black text-white pb-4">
      <div className="md:flex  grid justify-center md:justify-between items-center gap-3 w-[90%] md:w-[97%] mx-auto">
        <div className="flex flex-1 flex-col mt-4 md:mt-0 justify-center items-center md:items-start gap-4 order-last md:order-first">
          <span>Contact Info : </span>
          <div className="flex justify-center items-center gap-1">
            <span>Phone Number : </span>

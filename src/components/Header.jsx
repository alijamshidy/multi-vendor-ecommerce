...
import { useDispatch, useSelector } from "react-redux";
import { Link } from "react-router-dom";
import { get_customer_card, get_customer_wishlist } from "../store/Reducers/cardReducer";
...
const Header = () => {
  ...
  // useEffect(()=>{
  //   if (userInfo?.id) {
  //     dispatch(get_customer_wishlist())
  //     dispatch(get_customer_card())
  //   }
  // },[userInfo])
  ...
  return (
    <div className="w-full relative flex-col flex justify-center items-center">
      ...
      <div className="w-full flex justify-around mt-8 gap-5 items-center">
        <div className="w-3/12 min-[800px]:flex hidden gap-3 justify-start items-center">
          <span className="border-[1px] p-3 rounded-full border-black">
            <FaPhoneAlt />
          </span>
          <div className="font-bold">
